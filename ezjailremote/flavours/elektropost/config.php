...
$org_logo_width  = '388';
$org_logo_height = '90';
$org_title     = "elektropost $version";
$signout_page  = '';
$frame_top     = '_top';

$provider_uri     = 'http://erdgeist.org/arts/software/elektropost/';
$provider_name     = 'Netzkooperative Berlin';
$motd = "";
...
$domain                 = '%(hostname)s';
$imapServerAddress      = '%(hostname)s';
$imapPort               = 143;
$useSendmail            = false;
$smtpServerAddress      = '%(hostname)s';
$smtpPort               = 25;
...
$encode_header_key      = 'plasmakocher';
